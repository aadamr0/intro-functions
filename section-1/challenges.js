...
runTest('checking multiTypeArray', function () {
  ...
  check(typeof multiTypeArray[0]).isEqualTo(typeof multiTypeArray[0]);
  check(typeof multiTypeArray[1]).isEqualTo(typeof multiTypeArray[1]);
  check(typeof multiTypeArray[2]).isEqualTo(typeof multiTypeArray[2]);
  check(typeof multiTypeArray[3]).isEqualTo(typeof multiTypeArray[3]);
});
